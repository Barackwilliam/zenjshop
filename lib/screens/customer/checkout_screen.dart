...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void _placeOrder() async {
    ...
    final totalToPay = cartService.totalAmount; // save before clearing
    ...
    for (final entry in byShop.entries) {
      ...
      final orderId =
          '${DateTime.now().millisecondsSinceEpoch}${shopId.substring(0, 4)}';
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                Lang.isSwahili
                    ? 'Tafadhali kamilisha malipo yako'
              ...
              Container(
                ...
                child: Column(
                  children: [
                    // Amount
                    Text(
                      Lang.isSwahili ? 'Kiasi cha Kulipa:' : 'Amount to Pay:',
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        color:
                            isDark
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Text(
                            Lang.isSwahili
                                ? 'Inakubali mitandao yote:'
                                : 'Accepts all networks:',
                            style: GoogleFonts.poppins(
                              fontSize: 11,
                              color:
                                  isDark
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'TSh ${item.product.price.toStringAsFixed(0)} × ${item.quantity}',
                                    style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      color:
                                          isDark
